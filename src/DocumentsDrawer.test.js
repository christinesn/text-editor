...
it("Opens the drawer", () => {
  ...
  const { getByLabelText } = renderWithTheme(
    <DocumentsDrawer open={false} setOpen={setOpen} saves={[]} />
  );
...
it("Closes the drawer", () => {
  ...
  const { getByLabelText } = renderWithTheme(
    <DocumentsDrawer open={true} setOpen={setOpen} saves={[]} />
  );
...
it("Opens the download dialog", () => {
  const { getByLabelText, getByText } = renderWithTheme(
    <DocumentsDrawer open={true} saves={[]} />
  );
...
it("Lists all saved documents", () => {
  const { getByText } = renderWithTheme(
    <DocumentsDrawer open={true} saves={saves} />
  );
...
it("Deletes documents", () => {
  ...
  const { getByTestId } = renderWithTheme(
    <DocumentsDrawer open={true} saves={saves} setSaves={setSaves} />
  );
